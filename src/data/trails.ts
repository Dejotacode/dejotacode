...
export const trails: Trail[] = [
  ...
  },
  {
    ...
    description: "Entenda como a web funciona e construa seu primeiro projeto com uma base clara.",
    outcome: "Uma página própria e fundamentos suficientes para continuar praticando JavaScript e Git.",
    level: "Iniciante",
    icon: "</>",
    available: true,
    lessons: [
